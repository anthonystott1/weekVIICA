...
public class ProjectDao extends DaoBase {
	...
	private static final String FETCH_MATERIALS_SQL = "SELECT * FROM material WHERE project_id = ?";
    private static final String FETCH_STEPS_SQL = "SELECT * FROM step WHERE project_id = ?";
    private static final String FETCH_CATEGORIES_SQL = "SELECT c.* FROM category c JOIN project_category pc ON c.category_id = pc.category_id WHERE pc.project_id = ?";
    ...
    try (Connection conn = DbConnection.getConnection()) {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            try (ResultSet rs = stmt.executeQuery()) {
                ...
                /**
                 * Alternative approach in solutions
	...
	public boolean deleteProject(Integer projectId) {
		...
		//@formatter:on
		 ...
		 try (Connection conn = DbConnection.getConnection()) {
	            ...
	            */	//would not work project.getProjectId() would not work.
